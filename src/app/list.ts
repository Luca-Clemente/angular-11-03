export const listData = [
  {
    id: 1,
    curso: 'Negócios,Marketing e Eletrônicos',
  ...
  {
    id: 2,
    curso: 'Desenvolvimento para servidores II',
  ...
  {
    id: 3,
    curso: 'Projeto de Prototipagem e Testes de Usabilidade',
    diaDaSemana: 'Sábado',
    horario: '8:00-11:30',
    ementa:
  ...
  {
    id: 4,
    curso: 'Desenvolvimento para dispositivos Móveis I',
  ...
  {
    id: 5,
    curso: 'Tópicos Especiais em Sistemas para Internet II',
  ...
  {
    id: 6,
    curso: 'Projeto de Trabalho de Graduação em Sistemas para Internet I',
    diaDaSemana: 'Sábado',
    horario: '11:30 - 13:00',
    ementa:
